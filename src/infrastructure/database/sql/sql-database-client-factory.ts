...
export class SQLDatabaseClientFactory {
  ...
  private constructor(
    ...
    this.logger.info("Initializing SQL Database Client Factory with config:", {
    ...
    if (!user || !password || !host || !database) {
      this.logger.error("Missing required database configuration. Please check environment variables.");
