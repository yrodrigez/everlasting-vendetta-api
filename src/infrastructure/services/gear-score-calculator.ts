import type { EquippedItem } from "@entities/gearscore/equipped-item";
import { INVENTORY_TYPE_INFO } from "@entities/gearscore/inventory-type";
...
export class GearScoreCalculator {
    ...
    calculateItemScore(item: EquippedItem, classToken?: string): number {
        ...
        if (classToken?.toUpperCase() === "HUNTER") {
